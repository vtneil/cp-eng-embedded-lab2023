...
void startLed3(void *argument);

void startLed4(void *argument);
...
int main(void) {
    ...
    /* creation of led3 */
    led3Handle = osThreadNew(startLed3, NULL, &led3_attributes);

    /* creation of led4 */
    led4Handle = osThreadNew(startLed4, NULL, &led4_attributes);
...
/* USER CODE BEGIN Header_startLed3 */
/**
* @brief Function implementing the led3 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_startLed3 */
void startLed3(void *argument) {
    /* USER CODE BEGIN startLed3 */
    /* Infinite loop */
    for (;;) {
        HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_1);
        osDelay(128);
    }
    /* USER CODE END startLed3 */
}

/* USER CODE BEGIN Header_startLed4 */
/**
* @brief Function implementing the led4 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_startLed4 */
void startLed4(void *argument) {
    /* USER CODE BEGIN startLed4 */
    /* Infinite loop */
    for (;;) {
        HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_4);
        osDelay(64);
    }
    /* USER CODE END startLed4 */
}
